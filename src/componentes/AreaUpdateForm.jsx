...
function management_form() {
  ...
  /* Obteniendo los datos del Area */
  const AreaToEdit = location.state.AreaToEdit;
  
  const [formData, setFormData] = useState({
    id: AreaToEdit ? AreaToEdit.area_id : 0,
    nombre: AreaToEdit ? AreaToEdit.nombre : "",
  });
...
export default management_form;